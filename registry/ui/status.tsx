...
type StatusType = VariantProps<typeof statusVariants> & ComponentProps<"div"> & useRender.ComponentProps<"div">;
...
function Status({ className, variant = "default", render, ...props }: StatusType) {
  return useRender({
    defaultTagName: "div",
